...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.ContextRequestAudit(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.ContextRequestAudit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.ContextRequestAudit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.ContextRequestAudit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.ContextRequestAudit(), middleware.Distribute())
	{
